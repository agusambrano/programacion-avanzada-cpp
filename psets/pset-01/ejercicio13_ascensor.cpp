...
int main() {
    ...
    bool resultado1 = ascensor.setRangoPisos(-1, 20);

    std::cout << std::boolalpha;
    std::cout << "Rango aceptado (-1 a 20): " << resultado1 << std::endl;
    std::cout << "Minimo: " << ascensor.getPisoMinimo() << std::endl;
    std::cout << "Maximo: " << ascensor.getPisoMaximo() << std::endl;

    bool resultado2 = ascensor.setRangoPisos(30, 10);

    std::cout << "Rango aceptado (30 a 10): " << resultado2 << std::endl;
    std::cout << "Minimo: " << ascensor.getPisoMinimo() << std::endl;
    std::cout << "Maximo: " << ascensor.getPisoMaximo() << std::endl;
